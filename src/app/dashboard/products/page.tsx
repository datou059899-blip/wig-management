            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-500">状态/异常</th>
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-500">最近同步</th>
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-500">接下来做什么</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                {filteredProducts.map((product) => {
                  ...
                  <tr key={product.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-sm text-gray-600">{formatTime(syncTime)}</td>
                    <td className="px-4 py-3">
                      <div className="space-y-1">
